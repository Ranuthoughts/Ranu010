...
public class AddMembervirtual extends Baseclass{
 ...
 public Properties setBaseVariable() {
	...
	@Test
	public void memberaddvirtual() throws InterruptedException, IOException {
          ...
          driver.findElement(By.className("cy-DialMobNum")).sendKeys("9090900001");
          Thread.sleep(2000);
